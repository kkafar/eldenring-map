...
export const profilesTable = sqliteTable(
  "profiles",
  {
    ...
    userName: text("user_name")
      .notNull()
      .references(() => usersTable.name, foreignKeyCascadeActions),
  },
  (table) => {
    return [primaryKey({ columns: [table.profileName, table.userName] })];
  },
);

export const markersTable = sqliteTable(
  "marker_visited",
  {
...
export type ProfilesTableInsert = typeof profilesTable.$inferInsert;
export type MarkersTableInsert = typeof markersTable.$inferInsert;
